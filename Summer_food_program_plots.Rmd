...
# this will find the file with the budget and actual pattern.
bud_vs_actuals_files <- list.files(here(), pattern = "FY \\d{4} Budget and Actual.*\\.xlsx", full.names = TRUE)

# Read the latest file
bud_vs_actuals <- read.xlsx(bud_vs_actuals_files)
