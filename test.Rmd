...
month_columns <- column_names[str_detect(column_names, "Actuals_")]
...
# add missing months into teh table
...
expense_report_tbl <- expense_report_tbl |> 
  mutate(`Total Expenditures` = rowSums(across(all_of(month.name)), na.rm = TRUE))
