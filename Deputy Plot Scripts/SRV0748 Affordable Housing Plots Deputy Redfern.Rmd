...
# saving the plot
ggsave("ah_tot_neg_ccenter_deputy_wendi.pdf", 
       width = 30, height = 20)
```
...
# saving the plot
ggsave("ah_tot_neg_spcat_deputy_wendi.pdf", 
       width = 30, height = 20)
```
...
ah_max_spent_data <- ah_actual_spent |> 
...
ah_july_spending_plot <- ggplot(ah_max_spent_data, aes(x = `Cost Center`, y = `Actuals_2024-07`)) +
...
# Display the plot
print(ah_july_spending_plot)

# saving the plot
ggsave("ah_july_spending_deputy_wendi.pdf", 
       width = 30, height = 20)
```
