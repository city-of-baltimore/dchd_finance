...
sfsp_nh_max_spent_data <- sfsp_nh_actual_spent |> 
...
sfsp_nh_july_spending_plot <- ggplot(sfsp_nh_max_spent_data, aes(x = `Cost Center`, y = `Actuals_2024-07`)) +
...
# Display the plot
print(sfsp_nh_july_spending_plot)

# saving the plot
ggsave("sfsp_nh_july_spending_deputy_nicole.pdf", 
       width = 30, height = 20)
```
