...
# display the plot
print(csp_mc_tot_neg_ccenter)

# saving the plot
ggsave("csp_mc_tot_neg_ccenter_deputy_mary.pdf", width = 30, height = 20)
```
...
# display the plot
print(csp_mc_tot_neg_spcat)

# saving the plot
ggsave("csp_mc_tot_neg_spcat_deputy_wendi.pdf", width = 30, height = 20)
```
...
july_column <- grep("Actuals_\\d{4}-07$", names(csp_mc_actual_spent), value = TRUE)

# calculate the maximum spending for each cost center
csp_mc_max_spent_data <- csp_mc_actual_spent |> 
...
csp_mc_july_spending_plot <- ggplot(csp_mc_max_spent_data, aes(x = `Cost Center`, y = `Actuals_2024-07`)) +
...
# Display the plot
print(csp_mc_july_spending_plot)

# saving the plot
ggsave("csp_mc_july_spending_deputy_wendi.pdf", width = 30, height = 20)
```
