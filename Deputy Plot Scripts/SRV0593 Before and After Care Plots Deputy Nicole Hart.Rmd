...
# saving the plot
ggsave("bac_nh_tot_neg_ccenter_deputy_nicole.pdf", width = 30, height = 20) # this will save to your local drive
```
...
# saving the plot
ggsave("bac_nh_tot_neg_spcat_deputy_nicole.pdf", width = 30, height = 20)
```
...
# automatically detect the column for July
july_column <- grep("Actuals_\\d{4}-07$", names(bac_nh_actual_spent), value = TRUE)


# calculate the maximum spending for each cost center
bac_nh_max_spent_data <- bac_nh_actual_spent |> 
...
bac_nh_july_spending_plot <- ggplot(bac_nh_max_spent_data, aes(x = `Cost Center`, y = `Actuals_2024-07`)) +
...
# Display the plot
print(bac_nh_july_spending_plot)

# saving the plot
ggsave("bac_nh_july_spending_deputy_nicole.pdf", width = 30, height = 20)
```
