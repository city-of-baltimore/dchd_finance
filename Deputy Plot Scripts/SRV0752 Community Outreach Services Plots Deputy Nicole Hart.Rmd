...
# saving the plot
ggsave("cos_nh_tot_neg_ccenter_deputy_nicole.pdf",
       width = 30, height = 20)
```
...
# saving the plot
ggsave("cos_nh_tot_neg_spcat_deputy_nicole.pdf", 
       width = 30, height = 20)
```
...
cos_nh_max_spent_data <- cos_nh_actual_spent |> 
...
cos_nh_july_spending_plot <- ggplot(cos_nh_max_spent_data, aes(x = `Cost Center`, y = `Actuals_2024-07`)) +
...
# Display the plot
print(cos_nh_july_spending_plot)

# saving the plot
ggsave("cos_nh_july_spending_deputy_nicole.pdf", 
       width = 30, height = 20)
```
