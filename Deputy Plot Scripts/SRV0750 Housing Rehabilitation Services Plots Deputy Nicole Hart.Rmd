...
# saving the plot
ggsave("hrs_nh_tot_neg_ccenter_deputy_nicole.pdf",
       width = 30, height = 20)
```
...
# saving the plot
ggsave("hrs_nh_tot_neg_spcat_deputy_nicole.pdf", 
       width = 30, height = 20)
```
...
hrs_nh_max_spent_data <- hrs_nh_actual_spent |> 
...
hrs_nh_july_spending_plot <- ggplot(hrs_nh_max_spent_data, aes(x = `Cost Center`, y = `Actuals_2024-07`)) +
...
# Display the plot
print(hrs_nh_july_spending_plot)

# saving the plot
ggsave("hrs_nh_july_spending_deputy_nicole.pdf", 
       width = 30, height = 20)
```
