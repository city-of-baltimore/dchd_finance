...
rlpc_jh_nh_max_spent_data <- rlpc_jh_nh_actual_spent |> 
...
rlpc_jh_nh_july_spending_plot <- ggplot(rlpc_jh_nh_max_spent_data, aes(x = `Cost Center`, y = `Actuals_2024-07`)) +
...
# Display the plot
print(rlpc_jh_nh_july_spending_plot)

# saving the plot
ggsave("rlpc_jh_nh_july_spending_deputy_jason.pdf", 
       width = 45, height = 30)
```
