...
rlpc_jh_nh_tot_neg_ccenter <- ggplot(rlpc_jh_nh_negative_spending, aes(x = reorder(`Cost Center`, `Total Spent`), y = `Total Spent`)) +
...
# display the plot
print(rlpc_jh_nh_tot_neg_ccenter)
...
# display the plot
print(rlpc_jh_nh_tot_neg_spcat)
...
# Display the plot
print(rlpc_jh_nh_actual_spent_plot)
