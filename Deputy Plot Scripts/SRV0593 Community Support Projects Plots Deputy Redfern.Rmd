...
# saving the plot
ggsave("csp_tot_neg_ccenter_deputy_wendi.pdf", 
       width = 30, height = 20)
```
...
# saving the plot
ggsave("csp_tot_neg_spcat_deputy_wendi.pdf", 
       width = 30, height = 20)
```
...
csp_max_spent_data <- csp_actual_spent |> 
...
csp_july_spending_plot <- ggplot(csp_max_spent_data, aes(x = `Cost Center`, y = `Actuals_2024-07`)) +
...
# Display the plot
print(csp_july_spending_plot)

# saving the plot
ggsave("csp_july_spending_deputy_wendi.pdf",
       width = 30, height = 20)
```
