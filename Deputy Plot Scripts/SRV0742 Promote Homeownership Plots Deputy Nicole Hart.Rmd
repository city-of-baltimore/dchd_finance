...
# saving the plot
ggsave("ph_nh_tot_neg_ccenter_deputy_nicole.pdf", 
       width = 30, height = 20)
```
...
# saving the plot
ggsave("ph_nh_tot_neg_spcat_deputy_nicole.pdf", 
       width = 30, height = 20)
```
...
ph_nh_max_spent_data <- ph_nh_actual_spent |> 
...
ph_nh_july_spending_plot <- ggplot(ph_nh_max_spent_data, aes(x = `Cost Center`, y = `Actuals_2024-07`)) +
...
# Display the plot
print(ph_nh_july_spending_plot)

# saving the plot
ggsave("ph_nh_july_spending_deputy_nicole.pdf", 
       width = 30, height = 20)
```
