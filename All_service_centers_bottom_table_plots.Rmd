...
ays_gf_comparison_data <- data.frame(
  Category = rep(c("Salaries/OPC Projections", "Other EXP Projections", "Total Projections"), each = nrow(alys_gf_final_tbl)),  
...
ggplot(ays_gf_comparison_data, aes(x = Category, y = Value, fill = Category)) +
  ...
  scale_fill_manual(values = c("Salaries/OPC Projections" = "steelblue", 
                               "Other EXP Projections" = "darkgreen",
                               "Total Projections" = "gray")) +  # Custom colors)) +  # Custom colors
...
aystpe_comparison_data <- data.frame(
  ...
  Fund = c(
    rep("1001 General Grants Fund", nrow(alys_gf_final_tbl)), 
    rep("GL YTD EXP 1001 General Grants Fund", nrow(alys_sf_final_tbl)), 
    rep("1001 General Grants Fund", nrow(alys_gf_final_tbl)), 
    rep("GL YTD EXP 5000 State Grants Fund", nrow(alys_sf_final_tbl)),
    rep("1001 General Grants Fund", nrow(alys_gf_final_tbl)), 
    rep("GL YTD EXP 5000 State Grants Fund", nrow(alys_sf_final_tbl))
  ),  
  Value = c(
