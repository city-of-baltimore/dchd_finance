...
ays_gf_comparison_data <- data.frame(
  Category = rep(c("Salaries/OPC Projections", "Other EXP Projections"), each = nrow(alys_gf_final_tbl)),  
  Fund = rep("1001 General Grants Fund", times = 2 * nrow(alys_gf_final_tbl)),  
  Value = c(
...
ays_sf_comparison_data <- data.frame(
  Category = rep(c("Salaries/OPC Projections", "Other EXP Projections"), each = nrow(alys_sf_final_tbl)),  
  Fund = rep("1001 General Grants Fund", times = 2 * nrow(alys_sf_final_tbl)),  
  Value = c(
