...
all_expense_rep <- all_expense_report_tbl |> 
...
writeData(wb1, "All Service Centers Report", all_expense_rep, startRow = 2, startCol = 1, colNames = TRUE)
...
mergeCells(all_wb_combined, "tables_unite", cols = 1:ncol(all_expense_rep), rows = 1)
addStyle(all_wb_combined, "tables_unite", title_style_summer, rows = 1, cols = 1:ncol(all_expense_rep), gridExpand = TRUE)

# write the first table
writeData(all_wb_combined, "tables_unite", all_expense_rep, startRow = 2, startCol = 1, colNames = TRUE)

# apply column header style to the first table
addStyle(all_wb_combined, "tables_unite", header_style_summer, rows = 2, cols = 1:ncol(all_expense_rep), gridExpand = TRUE)
