...
mergeCells(wb_combined, "tables_unite", cols = (num_cols_summer + 3):(num_cols_summer + 2 + ncol(all_analysis_tbl)), rows = 1)
addStyle(wb_combined, "tables_unite", title_style_analysis, rows = 1, cols = (num_cols_summer + 3):(num_cols_summer + 2 + ncol(all_analysis_tbl)), gridExpand = TRUE)

# write the second table
writeData(wb_combined, "tables_unite", all_analysis_tbl, startRow = 2, startCol = num_cols_summer + 3, colNames = TRUE)

# apply column header style to the second table
addStyle(wb_combined, "tables_unite", header_style_analysis, rows = 2, cols = (num_cols_summer + 3):(num_cols_summer + 2 + ncol(all_analysis_tbl)), gridExpand = TRUE)
